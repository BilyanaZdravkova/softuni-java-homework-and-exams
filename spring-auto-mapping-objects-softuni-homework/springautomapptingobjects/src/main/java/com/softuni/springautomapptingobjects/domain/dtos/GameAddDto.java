...
public class GameAddDto {
    ...
    @Size(min = 3, max = 100, message = "Title length is not valid!")
    ...
    @DecimalMin(value = "0", message = "Price cannot be a negative number")
    ...
    @Min(value = 0, message = "Size cannot be a negative number")
    ...
    @Size(min = 20, message = "Description size is not valid")
